...
namespace Customer\Dns\DNS_HOST_3;
...
class CORE extends \Allice\Route\BASE {
	...
	self::PAGE_INDEX => [
	    ...
	    'route'	=> [
			    'method'	=> [
					    'class'	=> \Customer\Model\DNS_HOST_3\Rabbit::class,
					    'method'	=>'run'
					    ],
			    'view' 	=> [
					    'class'	=> \Customer\View\DNS_HOST_3\View_Rabbit::class,
					    'method'	=> 'run'
					    ]
			    ],
	],
	...
	self::PAGE_404 => [
	    ...
	    'route'	=> [
			    'method'	=> [
					    'class'	=> \Customer\Model\DNS_HOST_3\Route_404::class, 
					    'method'	=> 'run'
					    ],
			    'view' 	=> [
					    'class'	=> \Customer\View\DNS_HOST_3\V404::class,
					    'method'	=> 'run'
					    ]
			    ],
	],
