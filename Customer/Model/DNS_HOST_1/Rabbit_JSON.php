...
class Rabbit_JSON extends \Allice\Model\BASE {
    ...
    function run ($req) { 
	try { 
	    $d = json_decode($this->Pudding->_get_input());
	    //$s = var_export("<br>START RUN MODEL...<br> args: url:".json_encode($req->VALUE)." dns_arg:".json_encode($req->VALUE_DNS)." ".json_encode($d),true); 
